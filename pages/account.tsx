            ...
            <div className="grid grid-cols-5 h-full">
                ...
                <div className="col-span-1 bg-[#242935] p-6 min-h-full flex flex-col items-start justify-between">
                    ...
                    <div className='flex flex-col items-start justify-center'>
                        ...
                        <div onClick={() => setCurrentTab('dashboard')} className='text-[#BDBDBD] text-xl font-medium flex flex-row gap-2 items-center justify-start mb-6 cursor-pointer'>
                            <DashboardIcon className='w-6 h-6' />
                            <div>Dashboard</div>
                        </div>

                        <div onClick={() => setCurrentTab('courses')} className='text-[#BDBDBD] text-xl font-medium flex flex-row gap-2 items-center justify-start mb-6 cursor-pointer'>
