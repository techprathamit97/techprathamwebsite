    ...
    return (
        <div className='w-full h-auto flex flex-col items-center justify-center py-16 bg-[#f7f7f7]'>
            <div className='md:w-10/12 w-11/12 h-auto grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div className='md:col-span-1 text-justify p-4 rounded shadowBorder'>
                    <div className='md:text-2xl text-xl md:font-semibold font-medium mb-3'>Our Mission</div>
                    <div>
                ...
                <div className='md:col-span-1 text-justify p-4 rounded shadowBorder'>
                    <div className='md:text-2xl text-xl md:font-semibold font-medium mb-3'>Our Vision</div>
                    <div>
