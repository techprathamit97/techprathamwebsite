...
const HeaderAbout = () => {
    return (
        <div className='w-full h-auto flex flex-col items-center justify-center lg:pt-30 md:pt-24 sm:pt-24 pt-10'>
            <div className='w-full h-auto text-white flex flex-col items-center justify-center headerImage'>
                <div className='md:w-10/12 w-11/12 py-28 flex md:flex-row flex-col items-center justify-between'>
