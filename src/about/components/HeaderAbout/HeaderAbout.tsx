    ...
    return (
        <div className='w-full h-auto flex flex-col items-center justify-center lg:pt-30 md:pt-24 sm:pt-24 pt-10'>
            <div className='w-full h-auto flex items-center justify-center relative'>
                ...
                <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:text-6xl text-2xl font-semibold text-white text-center'>About Us</div>
            </div>
