...
const IntroSection = ({ course }: any) => {
    return (
        <div className='w-full h-auto flex flex-col items-center justify-center gap-6'>
            <div className='md:w-10/12 w-11/12 h-auto grid md:grid-cols-3 grid-cols-1 gap-8 py-16'>
                <div className='md:col-span-2 col-span-1 w-full h-auto flex flex-col items-start gap-4'>
