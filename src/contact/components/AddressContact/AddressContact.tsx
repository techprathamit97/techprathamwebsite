...
const AddressContact = () => {
    return (
        <div className='w-10/12 h-auto grid md:grid-cols-2 grid-cols-1 gap-10 place-content-center'>
            <div className='w-full grid grid-rows-3 gap-5 py-16 z-10 text-left'>
                <div
                    className='p-[3px] shadow flex items-center justify-center w-full h-full rounded-xl bg-gradient-to-tl'
                    style={{
                        backgroundImage: 'linear-gradient(to top left, #ff0000, #ff9900, #33cc33, #3399ff, #9900cc, #ff3399)'
                    }}
                >
                    <div className='row-span-1 w-full h-full flex flex-col p-4 rounded-lg bg-[#eee]'>
