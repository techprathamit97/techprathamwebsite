    ...
    return (
        <div className="col-span-1 bg-[#242935] p-6 min-h-full flex flex-col items-start justify-between">
            ...
            <div className='flex flex-col items-start justify-center'>
                ...
                <Link href='/admin/dashboard/profile' className='text-[#BDBDBD] text-xl font-medium flex flex-row gap-2 items-center justify-start mb-6 cursor-pointer'>
                    <AvatarIcon className='w-6 h-6' />
                    <div>Profile</div>
                </Link>

                <Link href='/admin/dashboard' className='text-[#BDBDBD] text-xl font-medium flex flex-row gap-2 items-center justify-start mb-6 cursor-pointer'>
                ...
                <Link href='/admin/dashboard/system' className='text-[#BDBDBD] text-xl font-medium flex flex-row gap-2 items-center justify-start mb-6 cursor-pointer'>
